	...
	<view class="content">
		<view class="box" :style='{"minHeight":"100vh","width":"100%","padding":"408rpx 80rpx 80rpx","background":"url(http://codegen.caihongy.cn/20221230/451dc9417d1a4527a67f9f14d47cf17b.jpg) no-repeat center top / 100% auto,#fff","height":"100%"}'>
			<view :style='{"padding":"60rpx 10%","boxShadow":"0px 0px 12rpx #ccc","borderColor":"#bbbbe1","borderRadius":"48rpx","background":"rgba(255,255,255,1)","borderWidth":"0 0 0px","display":"block","width":"100%","position":"relative","borderStyle":"solid","height":"auto"}'>
				...
				<view class="links" :style='{"boxShadow":"0px 0px 0px #eee","padding":"0","margin":"0 auto","alignItems":"flex-start","bottom":"-200rpx","display":"block","justifyContent":"center","borderRadius":"0px","flexWrap":"wrap","left":"0","background":"none","width":"100%","position":"absolute","height":"auto"}'>
					<view class="link-highlight" @tap="onRegisterTap('yonghu')" :style='{"border":"0px solid #fc7cad","padding":"16rpx 8rpx 0px","margin":"0px 8rpx 16rpx 0","color":"#666","borderRadius":"16rpx","textAlign":"left","background":"none","display":"inline-block","width":"auto","fontSize":"28rpx","order":"2"}'>注册用户</view>
				</view>
			</view>
		</view>
	</view>

		...
		<view :style='{"padding":"0","borderColor":"#21d5ae","margin":"0","alignItems":"flex-start","display":"block","justifyContent":"space-between","minHeight":"100vh","flexWrap":"wrap","background":"#d5f1f6","borderWidth":"0px 0","width":"100%","position":"relative","borderStyle":"dashed","height":"auto"}'>
			...
			<view :style='{"minHeight":"100vh","padding":"80rpx 0 100rpx","margin":"0","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20221230/5dd9030386864bee8dbcc815a8942660.png) no-repeat center top / 100% auto,url(http://codegen.caihongy.cn/20221230/6c6025ba94804e88a222a9febaaf8c2c.png) no-repeat center bottom / 100% auto,#d5f1f6","display":"flex","width":"100%","height":"auto"}'>
				...
				<view class="news-box1" :style='{"padding":"40rpx 24rpx 24rpx","margin":"0px 0 0","flexWrap":"wrap","background":"url() no-repeat center top","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
					<view @tap="onDetailTap(product)" v-for="(product,index) in list" :key="index" class="list-item" :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"20rpx","margin":"0 0 20rpx","borderColor":"#afe1ea","borderRadius":"20%","flexWrap":"wrap","background":"rgba(255,255,255,.96)","borderWidth":"16rpx","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					  <view class="list-item-body" :style='{"width":"calc(100% - 200rpx)","padding":"0","margin":"0","height":"auto","order":"2"}'>
						<view :style='{"padding":"0 20rpx","margin":"0","whiteSpace":"nowrap","overflow":"hidden","color":"#333","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis"}' class="title ">{{product.title}}</view>
					  ...
					  <image :style='{"width":"200rpx","margin":"0 auto","objectFit":"cover","borderRadius":"100%","display":"block","height":"200rpx"}' mode="aspectFill" class="listmpic" :src="baseUrl+product.picture"></image>
					</view>
				</view>
